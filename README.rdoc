...
Note: Do not forget to check the routes made available to you by Citygate with `rake routes` and to take a look at the doc at [rdoc](http://rubydoc.info/github/zamith/citygate/master/frames "Ruby Doc")
